...
public class PagerSlidingTabStripextends_tmp extends HorizontalScrollView {
	...
	public PagerSlidingTabStripextends_tmp(Context context) {
		this(context, null);
	}

	public PagerSlidingTabStripextends_tmp(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public PagerSlidingTabStripextends_tmp(Context context, AttributeSet attrs, int defStyle) {
	...
	public void setDefaultTabLayoutParams(int width){
