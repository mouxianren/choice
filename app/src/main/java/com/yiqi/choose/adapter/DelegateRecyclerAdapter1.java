...
public class DelegateRecyclerAdapter1 extends DelegateAdapter.Adapter{
    ...
    public DelegateRecyclerAdapter1(Context context, LayoutHelper helper, LinearLayout.LayoutParams params, List<Object> lists){
