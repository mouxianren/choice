...
public class DelegateRecyclerAdapter2 extends DelegateAdapter.Adapter{
    ...
    private int type;
    public DelegateRecyclerAdapter2(Context context, LayoutHelper helper, LinearLayout.LayoutParams params,List<Object> lists){
    ...
    public void noticeAdapter(List<Object> goodsList,int type){
        this.list.clear();
        this.list.addAll(goodsList);
        this.type=type;
        this.notifyDataSetChanged();
    }
    public void noticeAdapterNext(List<Object> goodsList,int type){
    ...
    public void noticAdapterVisible(int type){
        this.type=type;
        this.notifyDataSetChanged();
    }
