...
childView.setOnClickListener(new OnClickListener() {
    ...
    public void onClick(View v) {
        listener.onTouchSubproject(number);
    }
});
        }
    }
    ...
    private OnTouchSubprojectListener listener;
    public void setOnTouchSubprojectListener(OnTouchSubprojectListener listener){
        this.listener=listener;
    }
    public interface OnTouchSubprojectListener{
        void onTouchSubproject(int position);
    }
