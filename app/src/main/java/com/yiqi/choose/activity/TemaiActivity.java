...
public class TemaiActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.home_temai);
        ...
        if(NetJudgeUtils.getNetConnection(TemaiActivity.this)){
            ...
            ThreadPollFactory.getNormalPool().execute(new goodsThread(SplashActicity1.mQuanId,"",0+"","3",1));
        }else{
            home_jinxuan_listView.setVisibility(View.GONE);
            home_jinxuan_nogoods.setVisibility(View.GONE);
        ...
        home_jinxuan_listView.setXListViewListener(new XListView.IXListViewListener() {
            ...
            public void onLoadMore() {
                if (home_jinxuan_listView.getProgressState()) {
                    if (NetJudgeUtils.getNetConnection(TemaiActivity.this)) {
                        page++;
                        ThreadPollFactory.getNormalPool().execute(new goodsThread(SplashActicity1.mQuanId,(String) SharedPfUtils.getData(TemaiActivity.this, "temaitime", ""),0+"","3",page));
                    } else {
        ...
        home_jinxuan_listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(NetJudgeUtils.getNetConnection(TemaiActivity.this)){
                    CustomProgressDialog.createDialog(TemaiActivity.this,"");
                    GoodsInfo info=(GoodsInfo)goodList.get(position-1);
                    clickUrl=info.getGoodsUrl();
                    ThreadPollFactory.getNormalPool().execute(new ClickThread(info.getNumIid()+"",TemaiActivity.this,hd));
                    ...
                    Toast.makeText(TemaiActivity.this,"您的网络不给力，请检查更新!",Toast.LENGTH_LONG).show();
                }
        ...
        home_jinxuan_listView.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                final Picasso picasso = Picasso.with(TemaiActivity.this);
                if (scrollState == SCROLL_STATE_IDLE || scrollState == SCROLL_STATE_TOUCH_SCROLL) {
                    picasso.resumeTag(TemaiActivity.this);
                } else {
                    picasso.pauseTag(TemaiActivity.this);
                }
            }
    ...
    private Handler hd = new Handler() {
        public void handleMessage(Message msg) {
            if (msg.what == 3) {
                try {
                    ...
                    if (code.equals("0")) {
                        ...
                        SharedPfUtils.saveStringData(TemaiActivity.this,"temaitime", time);
                        if (goods.equals("[]") || null == goods || goods.equals("null")) {
                            ...
                            if (goodList.size() > 0) {
                                ...
                                adapter = new MyAdapter(TemaiActivity.this);
            ...
            if (msg.what == 4) {
                try {
                    ...
                    if (code.equals("0")) {
                        ...
                        home_jinxuan_listView.stopRefresh();
                        home_jinxuan_listView.stopLoadMore();
                        Toast.makeText(TemaiActivity.this, "数据返回错误!", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                    home_jinxuan_listView.stopRefresh();
            ...
            if (msg.what == 7) {
                MyToast.show(TemaiActivity.this, 0,AndroidUtils.getWidth(TemaiActivity.this),
                        AndroidUtils.dip2px(TemaiActivity.this, 45), "您的网络不给力，请检查更新!");
                home_jinxuan_listView.stopRefresh();
            }
            if (msg.what == 8) {
                ...
                try {
                    ...
                    if (code.equals("0")) {
                        ...
                        if(TextUtils.isEmpty(data)){
                            if(NetJudgeUtils.getNetConnection(TemaiActivity.this)){
                            //    Toast.makeText(TemaiActivity.this,"本地转链地址!",Toast.LENGTH_LONG).show();
                                AlibcTrade.show(TemaiActivity.this, new AlibcPage(clickUrl),alibcShowParams, alibcTaokeParams, exParams , new DemoTradeCallback());
                            }else{
                                Toast.makeText(TemaiActivity.this,"您的网络不给力，请检查更新!",Toast.LENGTH_LONG).show();
                            }
                        }else{
                            if(NetJudgeUtils.getNetConnection(TemaiActivity.this)){
                                //Toast.makeText(TemaiActivity.this,"后台转链地址!",Toast.LENGTH_LONG).show();
                                AlibcTrade.show(TemaiActivity.this, new AlibcPage(data),alibcShowParams, null, exParams , new DemoTradeCallback());
                            }else{
                                Toast.makeText(TemaiActivity.this,"您的网络不给力，请检查更新!",Toast.LENGTH_LONG).show();
                            }
                        }
    ...
    public void onResume() {
        super.onResume();
        MobclickAgent.onPageStart("TemaiActivity");
    ...
    public void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd("TemaiActivity");
        ...
        public View getView(final int position, View convertView,
         ...
         GoodHodler holder = null;
            if (convertView == null || convertView.getTag() == null) {
                view = inflater.inflate(R.layout.layout_main_item_temai, null);
            ...
            PicassoUtils.loadImageWithHolderAndError(TemaiActivity.this, goodsInfo.getGoodsImage(), R.mipmap.picture, R.mipmap.picture, holder.good_img);
           ...
           holder.home_temai_discount.setText(goodsInfo.getDiscount()+"折");
