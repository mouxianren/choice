...
import com.yiqi.choose.adapter.DelegateRecyclerAdapter;
...
import static com.yiqi.choose.fragment.Youhui_zi_new_fragment_1.bannerList;

/**
 * Created by moumou on 17/12/18.
 */

public class Youhui_zi_new_fragment extends BaseFragment1_coupons {
...
//
//    public static List<Object> bannerList1;
    private int screenWidth;
    private RecyclerAdapterWithHF mAdapter;
    private MyHandler hd;
    DelegateAdapter adapter;
    SingleLayoutAdapter singleLayoutAdapter;

    SingleLayoutTypeAdapter mSingleLayoutTypeAdapter;
     DelegateRecyclerAdapter goodsAdapter;
    ...
    private boolean loadingVisiable;
...
//        ziList = new ArrayList<Object>();
    ...
    public void initData() {
        ...
        mRecyclerview.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                System.out.println("layoutManager==="+layoutManager);
    ...
    public void initGoodsListener(){
        goodsAdapter.setOnItemClickListenr(new DelegateRecyclerAdapter.OnItemClickListener() {
            @Override
        ...
        mStickyLayoutAdapter.setOnItemClickListener(new StickyLayoutAdapter.OnItemClickListener() {
            ...
            public void quanbuClick(int order) {
                if(orders!=0){
                    orders=order;
                    goodList.clear();
                    goodsAdapter.noticeAdapter(goodList);
    ...
    public void lazyLoad(String id) {
        ...
        if (typeId.equals("0")) {
            ...
            // adapter.addAdapter(singleLayoutAdapter);
                    ...
                    if (code.equals("0")) {
                        ...
                        if (bannerData.equals("[]") || null == bannerData || bannerData.equals("null")) {
                            ...
                            if (bannerList.size() > 0){
                                System.out.println("youzhixigdaozhelima");
                                if(hasBanner){
...
//                                mAdapter.notifyDataSetChanged();
                    ...
                    mTestRecyclerViewFrame.refreshComplete();
                    huanchongHight=(int)(mHomeRlArrow.getMeasuredHeight()-(double)(MetricsUtils.getDensity(getActivity())*50));
            ...
            if (msg.what == 4) {
                try {
                    ...
                    if (code.equals("0")) {
                        ...
                        goodsAdapter.notifyDataSetChanged();// 告诉listView数据发生改变，要求listView更新显示
                        mTestRecyclerViewFrame.refreshComplete();
    ...
    public void onResume() {
        super.onResume();
        MobclickAgent.onPageStart("Youhui_zi_new_fragment");
    ...
    public void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd("Youhui_zi_new_fragment");
        if (bannerList.size() > 0 && typeId.equals("0") && getUserVisibleHint()) {
            if (singleLayoutAdapter != null) {
                singleLayoutAdapter.bannerStartPlay();
            }
    ...
    public  SingleLayoutAdapter initBannerList(Context context, int wid, Activity activity) {
    ...
    public  SingleLayoutTypeAdapter initTypeFive(Context context, int wid) {
        LinearLayoutHelper linearLayoutHelper = new LinearLayoutHelper();
        //设置间距
        mSingleLayoutTypeAdapter = new SingleLayoutTypeAdapter(context, linearLayoutHelper, wid);
        return mSingleLayoutTypeAdapter;
    }
    public  SingleLayoutTypeAdapter initViewAdapter(Context context) {
        LinearLayoutHelper linearLayoutHelper = new LinearLayoutHelper();
        //设置间距
    ...
    public DelegateRecyclerAdapter initGoodsAdapter(Context context, int wid) {
        LinearLayoutHelper linearLayoutHelper = new LinearLayoutHelper();
        //设置间距
        goodsAdapter = new DelegateRecyclerAdapter(context, linearLayoutHelper, params);
        return goodsAdapter;
    }
    public StickyLayoutAdapter initStickAdapter(Context context) {
