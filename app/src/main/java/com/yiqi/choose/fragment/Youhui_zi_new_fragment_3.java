...
import com.yiqi.choose.adapter.DelegateRecyclerAdapter3;
...
public class Youhui_zi_new_fragment_3 extends BaseFragment1_coupons {
    ...
    private DelegateRecyclerAdapter3 goodsAdapter;
...
//                    adapter.addAdapter(mLoadingAdapter);
            ...
            if (msg.what == 4) {
                try {
                    ...
                    if (code.equals("0")) {
                        ...
                        goodsAdapter.noticeAdapterNext(ziList);// 告诉listView数据发生改变，要求listView更新显示
                        mTestRecyclerViewFrame.refreshComplete();
    ...
    public void initGoodsAdapter(Context context, int wid) {
        LinearLayoutHelper linearLayoutHelper = new LinearLayoutHelper();
        //设置间距
        goodsAdapter = new DelegateRecyclerAdapter3(context, linearLayoutHelper, params, goodList);
    }
     ...
     * 的到圈值接口
     */
    private class goodsThread1 implements Runnable {
        String code;
        String timeStemp;
        int page;
        String keyword;
        ...
        public goodsThread1(String code, String timeStemp, int page, String keyword, String categoryId, int order) {
            this.code = code;
            this.timeStemp = timeStemp;
            this.page = page;
            this.keyword = keyword;
