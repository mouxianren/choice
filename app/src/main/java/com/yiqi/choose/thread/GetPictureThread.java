...
public class GetPictureThread implements Runnable{
    ...
    public GetPictureThread(Handler handler,Context context){
    ...
    public void run() {
        try {
            ...
            String url = context.getResources().getString(R.string.appurltest) + "/shareimage"+"?stamp=" + UrlUtils.getTime() + "&encode=" + UrlUtils.getEncode();
