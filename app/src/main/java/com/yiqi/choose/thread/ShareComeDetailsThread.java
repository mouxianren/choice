...
public class ShareComeDetailsThread implements Runnable{
    private Handler handler;
    private Context context;
private String code;
    public ShareComeDetailsThread(Handler handler, Context context,String code){
    ...
    public void run() {
        try {
            ...
            String url = context.getResources().getString(R.string.appurltest) + "/activity/sharezuan"+"?stamp=" + UrlUtils.getTime() + "&encode=" + UrlUtils.getEncode();
