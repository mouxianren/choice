...
public class ShareTuiguanThread implements Runnable {
    private Handler handler;
    private Context context;
    private String code;
    private int page;
    public ShareTuiguanThread(Handler handler, Context context,String code,int page){
    ...
    public void run() {
        try {
            ...
            String url = context.getResources().getString(R.string.appurltest) + "/activity/tuiguang"+"?stamp=" + UrlUtils.getTime() + "&encode=" + UrlUtils.getEncode();
