...
/**
 * Created by moumou on 17/9/5.
 */

public class UrlUtils {
    private static String KEY = "8988933079978398849L";
    public static String getTime(){
        return String.valueOf(System.currentTimeMillis());
    }
    public static String getEncode(){
        return md5(getTopNineTime()+getTopNineToken(KEY));
    }
    public static String getTopNineTime(){
    ...
    public static String getTopNineToken(String token){
        if(token.length()<9){
            return "";
        }
