...
public class AliSdkWebViewProxyActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // AlibcTaokeParams alibcTaokeParams = new AlibcTaokeParams("mm_26632322_6858406_23810104", "mm_26632322_6858406_23810104", null); // 若非淘客taokeParams设置为null即可
        AlibcBasePage alibcBasePage = new AlibcDetailPage("http://163.com");
       // AlibcBasePage alibcBasePage = new AlibcMyCartsPage();
        AlibcShowParams alibcShowParams = new AlibcShowParams(OpenType.H5, false);
        AlibcTrade.show(AliSdkWebViewProxyActivity.this,webView, null, null,alibcBasePage,alibcShowParams,null,exParams, new DemoTradeCallback());
