...
public class DefaultLoadMoreViewFooter implements ILoadMoreViewFactory {
    ...
    private class LoadMoreHelper implements ILoadMoreView {
        ...
        protected CircularProgressView footerBar1;
        ...
        public void init(FootViewAdder footViewHolder, OnClickListener onClickRefreshListener) {
            ...
            footerBar1 = (CircularProgressView) footerView.findViewById(R.id.cp_image);
            footerBar1.innerStop();
        ...
        public void showNormal() {
            ...
            footerBar1.setVisibility(View.GONE);
            footerBar1.innerStop();
        ...
        public void showLoading() {
            ...
            footerBar1.setVisibility(View.VISIBLE);
            footerBar1.innerStart();
