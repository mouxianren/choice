...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        mProgressBar = (CircularProgressView)header.findViewById(R.id.cp_image_head);
        mLastUpdateTextView.setText("上次更新时间:"+new Date().toLocaleString());
    ...
    public void setRefreshTime(String time) {
        mLastUpdateTextView.setText(time);//将传递过来的参数设置到Header中显示
    }
    @Override
